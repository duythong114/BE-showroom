...
var checkCarName = function checkCarName(carName) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _index["default"].Car.findOne({
              where: {
                name: carName
              }
            });
...
var paginationCarList = function paginationCarList(page, limit) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var offSet, _yield$db$Car$findAnd, count, rows, totalPages, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            _yield$db$Car$findAnd = _context2.sent;
            count = _yield$db$Car$findAnd.count;
            rows = _yield$db$Car$findAnd.rows;
            if (count && rows) {
...
var createNewCar = function createNewCar(data) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return checkCarName(data.name);
          case 3:
            isCarNameExist = _context3.sent;
            if (isCarNameExist) {
              _context3.next = 10;
              break;
            }
            _context3.next = 7;
            return _index["default"].Car.create({
              name: data.name,
              model: data.model,
...
var updateCar = function updateCar(data) {
  return new Promise( /*#__PURE__*/function () {
...
var getCarById = function getCarById(carId) {
  return new Promise( /*#__PURE__*/function () {
...
var getBmwCar = function getBmwCar() {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            _context7.prev = 0;
            _context7.next = 3;
            return _index["default"].Car.findAll({
              where: {
                model: "bmw"
              },
              order: [['id', 'ASC']],
...
var getFerrariCar = function getFerrariCar() {
  return new Promise( /*#__PURE__*/function () {
...
var getLamborghiniCar = function getLamborghiniCar() {
  return new Promise( /*#__PURE__*/function () {
