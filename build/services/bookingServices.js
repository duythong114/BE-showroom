...
var checkBooking = function checkBooking(userId) {
...
var paginationBookingList = function paginationBookingList(page, limit) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var offSet, _yield$db$Booking$fin, count, rows, totalPages, data;
...
var createNewBooking = function createNewBooking(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var isBookingExist, dataEmail;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return checkBooking(data.userId);
          case 3:
            isBookingExist = _context3.sent;
            if (isBookingExist) {
              _context3.next = 13;
              break;
            }
            dataEmail = {
              ...
              carName: data === null || data === void 0 ? void 0 : data.carName
            };
            _context3.next = 8;
            return (0, _sendEmailServices.sendBookingEmail)(dataEmail);
          case 8:
            _context3.next = 10;
...
var updateBooking = function updateBooking(data) {
  return new Promise( /*#__PURE__*/function () {
...
var getBookingByUserId = function getBookingByUserId(userId) {
  return new Promise( /*#__PURE__*/function () {
