...
var _JWTServices = require("./JWTServices");
var _hashPasswordService = _interopRequireDefault(require("./hashPasswordService"));
var _getRoleByGroupService = _interopRequireDefault(require("./getRoleByGroupService"));
var _sendEmailServices = require("./sendEmailServices");
...
var loginUser = function loginUser(email, password) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var isEmailExist, user, checkPassword, groupId, roles, accessTokenPayload, accessTokenSignature, accessTokenExpireTime, accessToken, refreshTokenPayload, refreshTokenSignature, refreshTokenExpireTime, refreshToken, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.next = 15;
            return (0, _getRoleByGroupService["default"])(groupId);
          case 15:
            ...
            accessTokenSignature = process.env.ACCESS_TOKEN_SIGNATURE;
            accessTokenExpireTime = process.env.ACCESS_TOKEN_EXPIRE_TIME;
            _context2.next = 21;
            return (0, _JWTServices.createAccessToken)(accessTokenPayload, accessTokenSignature, accessTokenExpireTime);
          case 21:
            ...
            refreshTokenSignature = process.env.REFRESH_TOKEN_SIGNATURE;
            refreshTokenExpireTime = process.env.REFRESH_TOKEN_EXPIRE_TIME;
            _context2.next = 27;
            return (0, _JWTServices.createRefreshToken)(refreshTokenPayload, refreshTokenSignature, refreshTokenExpireTime);
          case 27:
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            _context3.next = 7;
            return (0, _hashPasswordService["default"])(data.password);
          case 7:
...
var createUser = function createUser(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(resolve, reject) {
      var arrInput, arrInputName, i, isEmailExist, hashPassword;
...
var deleteUser = function deleteUser(userId) {
  return new Promise( /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(resolve, reject) {
      var user, _user$Group, groupName;
...
var updateUser = function updateUser(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(resolve, reject) {
      var user, _user$Group2, groupName;
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 4:
            ...
            groupName = user === null || user === void 0 || (_user$Group2 = user.Group) === null || _user$Group2 === void 0 ? void 0 : _user$Group2.name;
            if (!(groupName === 'manager')) {
              _context8.next = 11;
              break;
            }
...
var paginationUserList = function paginationUserList(page, limit) {
  return new Promise( /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          ...
          case 4:
            _yield$db$User$findAn = _context9.sent;
...
var refreshUser = function refreshUser(userId) {
  return new Promise( /*#__PURE__*/function () {
...
var updatePersonalUser = function updatePersonalUser(data) {
  return new Promise( /*#__PURE__*/function () {
...
var changePassword = function changePassword(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(resolve, reject) {
      var user, checkPassword, hashPassword;
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 4:
            ...
            checkPassword = _bcryptjs["default"].compareSync(data === null || data === void 0 ? void 0 : data.password, user.password);
            if (!checkPassword) {
              _context12.next = 18;
              break;
            }
            _context12.next = 11;
            return (0, _hashPasswordService["default"])(data === null || data === void 0 ? void 0 : data.newPassword);
          case 11:
...
var forgotPassword = function forgotPassword(email) {
  return new Promise( /*#__PURE__*/function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(resolve, reject) {
      var user, randomPassword, hashPassword;
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 3:
            ...
            randomPassword = (Math.random() + 1).toString(36).substring(7); // send email
            _context13.next = 8;
            return (0, _sendEmailServices.sendNewPasswordEmail)(email, randomPassword);
          case 8:
            _context13.next = 10;
            return (0, _hashPasswordService["default"])(randomPassword);
          case 10:
